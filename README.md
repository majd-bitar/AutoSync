...
> A mobile app and web platform for car diagnostics, making it easier for mechanics to monitor and maintain vehicles.
>
...
###  AutoSync is built using the following technologies:
